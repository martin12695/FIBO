        ...
        <div class="tw3-container">
            <ul class="tw3-headerV2__actions clearfix right">
                <li class="menuItem tw3-header__actions__item">
                    <a style="margin-top: 10px;" href="{{ url('/signin') }}" class="tw3-button tw3-button--blue tw3-button--small tw3-button--rounded">Đăng nhập</a>
                </li>
                <li class="menuItem tw3-header__actions__item">
                    <a style="margin-top: 10px;" href="{{ url('/signup') }}" class="tw3-button tw3-button--blue tw3-button--small tw3-button--rounded">Đăng ký</a>
                </li>
            </ul>
        </div>
    </div>
