...
@section('content')
    @if ( $authstatus ==  1 )
    <h3 style="color:red; position: absolute;top: 64px;left: 147px;">Bạn chưa được xác thực để sử dụng chức năng này!</h3>
    @else
                            ...
                            <div class="jsInboxContainer inboxContainer">
                                ...
                                <div class="inboxContainer__tw3-personList jsMessageInboxList">
                                    <ul class="tw3-personList scrollPane jsMessageInboxListItems">
                                        ...
                                        <li class="tw3-person" >
                                            <a href="#" class="noline" data-toggle="tooltip" data-placement="bottom" onclick="makeChat({{$friend->id}})" title="{{isset($friend->latest_position->location_name) ? $friend->latest_position->location_name : '...'}}">
                                                ...
                                                <div class="tw3-person__info">
                                                    ...
                                                    <div class="tw3-person__info__description jsLastMessage">đang ở <span class="text--bold text--shadesOfBlack">{{isset($friend->latest_position->location_name) ? $friend->latest_position->location_name : '...'}}</span>.</div>
                                                </div>
                                            </a>
                                        </li>
                                        @endforeach
